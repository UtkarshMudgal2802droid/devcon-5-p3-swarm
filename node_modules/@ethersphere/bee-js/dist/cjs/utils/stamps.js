...
exports.getStampUsage = exports.getStampTheoreticalBytes = exports.getStampEffectiveBytesBreakpoints = exports.getStampEffectiveBytes = void 0;
...
Object.defineProperty(exports, "getStampEffectiveBytes", { enumerable: true, get: function () { return core_sdk_1.getStampEffectiveBytes; } });
Object.defineProperty(exports, "getStampEffectiveBytesBreakpoints", { enumerable: true, get: function () { return core_sdk_1.getStampEffectiveBytesBreakpoints; } });
Object.defineProperty(exports, "getStampTheoreticalBytes", { enumerable: true, get: function () { return core_sdk_1.getStampTheoreticalBytes; } });
Object.defineProperty(exports, "getStampUsage", { enumerable: true, get: function () { return core_sdk_1.getStampUsage; } });
/**
...
function getDepthForSize(size, encryption, erasureCodeLevel) {
    return (0, core_sdk_1.getDepthForSize)(size.toBytes(), encryption, erasureCodeLevel);
}
function convertEnvelopeToMarshaledStamp(envelope) {
    return (0, core_sdk_1.convertEnvelopeToMarshaledStamp)(envelope);
}
function marshalStamp(signature, batchId, timestamp, index) {
    return (0, core_sdk_1.marshalStamp)(signature, batchId, timestamp, index);
}
function mapPostageBatch(raw, encryption, erasureCodeLevel) {
    ...
    const effectiveBytes = (0, core_sdk_1.getStampEffectiveBytes)(raw.depth, encryption, erasureCodeLevel);
    const usage = raw.utilizationRatio ?? (0, core_sdk_1.getStampUsage)(raw.utilization, raw.depth, raw.bucketDepth);
    return {
        batchID: new core_sdk_1.BatchId(raw.batchID),
        ...
        theoreticalSize: size_1.Size.fromBytes((0, core_sdk_1.getStampTheoreticalBytes)(raw.depth)),
        duration,
        calculateSize(encryption, redundancyLevel) {
            const effectiveBytes = (0, core_sdk_1.getStampEffectiveBytes)(raw.depth, encryption, redundancyLevel);
