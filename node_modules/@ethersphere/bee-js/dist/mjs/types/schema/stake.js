...
export const GetStakeResponse = z.object({
  stakedAmount: z.string().transform(s => BZZ.fromPLUR(asNumberString(s, {
    name: 'stakedAmount'
  })))
});
export const GetWithdrawableStakeResponse = z.object({
  withdrawableAmount: z.string().transform(s => BZZ.fromPLUR(asNumberString(s, {
...
export const GetRedistributionStateResponse = z.object({
  minimumGasFunds: z.string().transform(s => DAI.fromWei(asNumberString(s, {
  ...
  block: z.number(),
  reward: z.string().transform(s => BZZ.fromPLUR(asNumberString(s, {
    name: 'reward'
  }))),
  fees: z.string().transform(s => DAI.fromWei(asNumberString(s, {
    name: 'fees'
  }))),
  isHealthy: z.boolean()
});