...
import { Bytes, MantarayNode as CoreMantarayNode, Reference } from '@ethersphere/core-sdk';
/**
 ...
 */
async function saveRecursively(node, bee, postageBatchId, options, requestOptions) {
 ...
 */
async function loadRecursively(node, bee, options, requestOptions) {
  for (const fork of node.forks.values()) {
...
export class MantarayNode {
  constructor(core = new CoreMantarayNode()) {
    this.core = core;
  }
  get obfuscationKey() {
