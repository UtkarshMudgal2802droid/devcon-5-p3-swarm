...
import { z } from 'zod';
import { Bytes, FeedIndex, Reference, keccak256, makeContentAddressedChunk, numberToUint64, uint64ToNumber, unmarshalContentAddressedChunk } from '@ethersphere/core-sdk';
import { unmarshalSingleOwnerChunk, uploadSingleOwnerChunkData, uploadSingleOwnerChunkWithWrappedChunk } from "../chunk/soc.js";
import * as bytes from "../api/bytes.js";
...
export async function updateFeedWithPayload(requestOptions, signer, topic, data, postageBatchId, options) {
  ...
  return uploadSingleOwnerChunkData(requestOptions, signer, postageBatchId, identifier, dataString.success ? Bytes.fromUtf8(dataString.data).toUint8Array() : data, options);
}
